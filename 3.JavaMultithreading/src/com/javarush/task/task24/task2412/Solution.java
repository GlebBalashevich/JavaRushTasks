    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double val1 = (Double) stock1.get("change");
                Double val2 = (Double) stock2.get("change");
                if (val1 == null) val1 = (Double) stock1.get("last") - (Double) stock1.get("open");
                if (val2 == null) val2 = (Double) stock2.get("last") - (Double) stock2.get("open");
